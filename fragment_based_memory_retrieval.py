...
# Source : tools/fragment_based_memory_retrieval.py
...
TOOL_PROMPT = (
    "Use fragment_based_memory_retrieval to recognize forgetfulness or recover memory fragments. "
...
class MemoryFragmentConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Fragment-based memory retrieval for distorted or forgotten memories.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "fragment_based_memory_retrieval.md",
...
class FragmentBasedMemoryRetrieval(
    BaseTool[
        MemoryFragmentArgs,
    ...
    description: ClassVar[str] = "Recollect memories via fragment-based retrieval when distorted or forgotten."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryFragmentArgs):
            return ToolCallDisplay(summary="fragment_based_memory_retrieval")
        return ToolCallDisplay(
            summary="fragment_based_memory_retrieval",
            details={

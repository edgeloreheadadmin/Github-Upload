...
# Source : tools/memory_timeline_classification.py
...
TOOL_PROMPT = (
    "Use memory_timeline_classification to classify memory timeline data or apply timeline-tagged calculations. "
...
class MemoryTimelineConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Classify memory based on timeline structure.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "memory_timeline_classification.md",
...
class MemoryTimelineClassification(
    BaseTool[
        MemoryTimelineArgs,
    ...
    description: ClassVar[str] = "Classify memory based on timeline data."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryTimelineArgs):
            return ToolCallDisplay(summary="memory_timeline_classification")
        return ToolCallDisplay(
            summary="memory_timeline_classification",
            details={

...
# Source : tools/memory_timeline_event_retrieval_version.py
...
TOOL_PROMPT = (
    "Use memory_timeline_event_retrieval_version for metadata timelines, perfect recall interfaces, or timeline retrieval. "
...
class TimelineRecallConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Memory retrieval through events within a timeline.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "memory_timeline_event_retrieval_version.md",
...
class MemoryTimelineEventRetrievalVersion(
    BaseTool[
        TimelineRecallArgs,
    ...
    description: ClassVar[str] = "Memory retrieval through events within a timeline."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, TimelineRecallArgs):
            return ToolCallDisplay(summary="memory_timeline_event_retrieval_version")
        return ToolCallDisplay(
            summary="memory_timeline_event_retrieval_version",
            details={

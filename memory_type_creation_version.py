...
# Source : tools/memory_type_creation_version.py
...
TOOL_PROMPT = (
    "Use memory_type_creation_version for memory caching, pipeline allocation, or memory type creation. "
...
class MemoryCachingConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Create types of memory.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "memory_type_creation_version.md",
...
class MemoryTypeCreationVersion(
    BaseTool[
        MemoryCachingArgs,
        MemoryCachingResult,
        MemoryCachingConfig,
    ...
    description: ClassVar[str] = "Create types of memory."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryCachingArgs):
            return ToolCallDisplay(summary="memory_type_creation_version")
        return ToolCallDisplay(
            summary="memory_type_creation_version",
            details={

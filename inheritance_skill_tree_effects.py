...
# Source : tools/inheritance_skill_tree_effects.py
...
TOOL_PROMPT = (
    "Use inheritance_skill_tree_effects for inheritance structures, habit stacking, or skill-tree effects. "
...
class InheritanceHabitConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Inheritance structures passing skills and effects across skill tree nodes.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "inheritance_skill_tree_effects.md",
...
class InheritanceSkillTreeEffects(
    BaseTool[
    ...
    description: ClassVar[str] = "Pass skills and effects across skill tree nodes via inheritance structures."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, InheritanceHabitArgs):
            return ToolCallDisplay(summary="inheritance_skill_tree_effects")
        return ToolCallDisplay(
            summary="inheritance_skill_tree_effects",
            details={

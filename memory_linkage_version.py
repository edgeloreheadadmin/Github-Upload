...
# Source : tools/memory_linkage_version.py
...
TOOL_PROMPT = (
    "Use memory_linkage_version for memory locations, allocation speed, categorization, or linkage. "
...
class MemoryLinkageVersion(
    ...
    description: ClassVar[str] = "Memory linkage."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryStructureArgs):
            return ToolCallDisplay(summary="memory_linkage_version")
        return ToolCallDisplay(
            summary="memory_linkage_version",
            details={

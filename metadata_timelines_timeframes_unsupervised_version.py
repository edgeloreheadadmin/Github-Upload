...
# Source : tools/metadata_timelines_timeframes_unsupervised_version.py
...
TOOL_PROMPT = (
    "Use metadata_timelines_timeframes_unsupervised_version for metadata timelines, perfect recall interfaces, or timeline retrieval. "
...
class TimelineRecallConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Metadata timelines/timeframes for unsupervised learning.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "metadata_timelines_timeframes_unsupervised_version.md",
...
class MetadataTimelinesTimeframesUnsupervisedVersion(
    BaseTool[
        TimelineRecallArgs,
    ...
    description: ClassVar[str] = "Metadata timelines/timeframes for unsupervised learning."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, TimelineRecallArgs):
            return ToolCallDisplay(summary="metadata_timelines_timeframes_unsupervised_version")
        return ToolCallDisplay(
            summary="metadata_timelines_timeframes_unsupervised_version",
            details={

...
# Source : tools/memory_structure_retrieval_transformation_version.py
...
TOOL_PROMPT = (
    "Use memory_structure_retrieval_transformation_version for memory structure retrieval, modeling, or linkage. "
...
class MemoryModelingConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Memory structure retrieval and transformation of data.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "memory_structure_retrieval_transformation_version.md",
...
class MemoryStructureRetrievalTransformationVersion(
    BaseTool[
        MemoryModelingArgs,
    ...
    description: ClassVar[str] = "Memory structure retrieval and transformation of data."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryModelingArgs):
            return ToolCallDisplay(summary="memory_structure_retrieval_transformation_version")
        return ToolCallDisplay(
            summary="memory_structure_retrieval_transformation_version",
            details={

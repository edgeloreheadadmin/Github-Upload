...
# Source : tools/perfect_memory_recall_multidimensional_multimodal_origin_locations.py
...
TOOL_PROMPT = (
    "Use perfect_memory_recall_multidimensional_multimodal_origin_locations for perfect memory recall with advanced timeline interfaces. "
...
class PerfectRecallConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Perfect memory recall using multi-dimensional and multi-modal timelines with origin-based retrieval locations.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "perfect_memory_recall_multidimensional_multimodal_origin_locations.md",
...
class PerfectMemoryRecallMultidimensionalMultimodalOriginLocations(
    BaseTool[
        PerfectRecallArgs,
        PerfectRecallResult,
        PerfectRecallConfig,
    ...
    description: ClassVar[str] = "Perfect memory recall using multi-dimensional and multi-modal timelines with origin-based retrieval locations."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, PerfectRecallArgs):
            return ToolCallDisplay(summary="perfect_memory_recall_multidimensional_multimodal_origin_locations")
        return ToolCallDisplay(
            summary="perfect_memory_recall_multidimensional_multimodal_origin_locations",
            details={

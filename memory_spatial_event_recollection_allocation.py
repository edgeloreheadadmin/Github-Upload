...
# Source : tools/memory_spatial_event_recollection_allocation.py
...
TOOL_PROMPT = (
    "Use memory_spatial_event_recollection_allocation to classify or process memories within events/timelines. "
...
class MemoryEventTimelineConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Allocate and process memories within events for spatial recollection.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "memory_spatial_event_recollection_allocation.md",
...
class MemorySpatialEventRecollectionAllocation(
    BaseTool[
    ...
    description: ClassVar[str] = "Allocate and process memories within events for spatial memory recollection."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryEventTimelineArgs):
            return ToolCallDisplay(summary="memory_spatial_event_recollection_allocation")
        return ToolCallDisplay(
            summary="memory_spatial_event_recollection_allocation",
            details={

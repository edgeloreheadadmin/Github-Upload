...
# Source : tools/memory_consolidation_recollection_events_timeline_version.py
...
TOOL_PROMPT = (
    "Use memory_consolidation_recollection_events_timeline_version for time-series timeline development or recollection. "
...
class TimelineSeriesConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Memory consolidation and recollection based on events within a timeline.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "memory_consolidation_recollection_events_timeline_version.md",
...
class MemoryConsolidationRecollectionEventsTimelineVersion(
    BaseTool[
        TimelineSeriesArgs,
    ...
    description: ClassVar[str] = "Memory consolidation and recollection based on events within a timeline."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, TimelineSeriesArgs):
            return ToolCallDisplay(summary="memory_consolidation_recollection_events_timeline_version")
        return ToolCallDisplay(
            summary="memory_consolidation_recollection_events_timeline_version",
            details={

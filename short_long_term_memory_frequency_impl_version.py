...
# Source : tools/short_long_term_memory_frequency_impl_version.py
...
TOOL_PROMPT = (
    "Use short_long_term_memory_frequency_impl_version for memory recognition, retention rate, or synchronization. "
...
class MemoryRateConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Short/long-term memory frequency implementation.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "short_long_term_memory_frequency_impl_version.md",
...
class ShortLongTermMemoryFrequencyImplVersion(
    BaseTool[
        MemoryRateArgs,
        MemoryRateResult,
        MemoryRateConfig,
    ...
    description: ClassVar[str] = "Short/long-term memory frequency implementation."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryRateArgs):
            return ToolCallDisplay(summary="short_long_term_memory_frequency_impl_version")
        return ToolCallDisplay(
            summary="short_long_term_memory_frequency_impl_version",
            details={

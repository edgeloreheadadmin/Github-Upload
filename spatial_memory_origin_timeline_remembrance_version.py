...
# Source : tools/spatial_memory_origin_timeline_remembrance_version.py
...
TOOL_PROMPT = (
    "Use spatial_memory_origin_timeline_remembrance_version for time-series timeline development or recollection. "
...
class TimelineSeriesConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Spatial memory origin location remembrance of specific timeline data.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "spatial_memory_origin_timeline_remembrance_version.md",
...
class SpatialMemoryOriginTimelineRemembranceVersion(
    BaseTool[
        TimelineSeriesArgs,
    ...
    description: ClassVar[str] = "Spatial memory origin location remembrance of specific timeline data."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, TimelineSeriesArgs):
            return ToolCallDisplay(summary="spatial_memory_origin_timeline_remembrance_version")
        return ToolCallDisplay(
            summary="spatial_memory_origin_timeline_remembrance_version",
            details={

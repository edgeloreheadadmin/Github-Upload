...
# Source : tools/multi_list_data_processing.py
...
TOOL_PROMPT = (
    "Use multi_list_data_processing for metadata-driven learning, multi-process execution, or inherited data structures. "
...
class LearningProcessConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Process multiple lists of data automatically.",
...
class MultiListDataProcessing(
    ...
    description: ClassVar[str] = "Process multiple lists of data automatically."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, LearningProcessArgs):
            return ToolCallDisplay(summary="multi_list_data_processing")
        return ToolCallDisplay(
            summary="multi_list_data_processing",
            details={

...
# Source : tools/parallel_inheritance_synaptic_processing.py
...
TOOL_PROMPT = (
    "Use parallel_inheritance_synaptic_processing for inheritance structures or healing/purification support. "
...
class InheritanceHealingConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Parallel processing across inheritance structures with synaptic changes.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "parallel_inheritance_synaptic_processing.md",
...
class ParallelInheritanceSynapticProcessing(
    BaseTool[
    ...
    description: ClassVar[str] = "Parallel processing across inheritance structures where synaptic changes take form."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, InheritanceHealingArgs):
            return ToolCallDisplay(summary="parallel_inheritance_synaptic_processing")
        return ToolCallDisplay(
            summary="parallel_inheritance_synaptic_processing",
            details={

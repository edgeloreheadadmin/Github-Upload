...
# Source : tools/perfect_memory_recall.py
...
TOOL_PROMPT = (
    "Use perfect_memory_recall for memory meta-data, timelines, or recall optimization. "
...
class PerfectMemoryRecall(
    ...
    description: ClassVar[str] = "Assist with perfect memory recall practices."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryMetaRecallArgs):
            return ToolCallDisplay(summary="perfect_memory_recall")
        return ToolCallDisplay(
            summary="perfect_memory_recall",
            details={

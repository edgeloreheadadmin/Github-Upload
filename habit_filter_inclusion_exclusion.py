...
# Source : tools/habit_filter_inclusion_exclusion.py
...
TOOL_PROMPT = (
    "Use habit_filter_inclusion_exclusion for equation-backed processes, multi-domain links, or habit filtering. "
...
class BackendHabitConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Filter habits by inclusion/exclusion criteria.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "habit_filter_inclusion_exclusion.md",
...
class HabitFilterInclusionExclusion(
    BaseTool[
        BackendHabitArgs,
        BackendHabitResult,
        BackendHabitConfig,
    ...
    description: ClassVar[str] = "Filter habits by inclusion or exclusion criteria."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, BackendHabitArgs):
            return ToolCallDisplay(summary="habit_filter_inclusion_exclusion")
        return ToolCallDisplay(
            summary="habit_filter_inclusion_exclusion",
            details={

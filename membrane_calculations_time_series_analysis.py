...
# Source : tools/membrane_calculations_time_series_analysis.py
...
TOOL_PROMPT = (
    "Use membrane_calculations_time_series_analysis to apply membrane-style calculations "
...
class MembraneTimeSeriesConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Membrane calculations for memory time series analysis.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "membrane_calculations_time_series_analysis.md",
...
class MembraneCalculationsTimeSeriesAnalysis(
    BaseTool[
    ...
    description: ClassVar[str] = "Apply membrane-style calculations for memory time series analysis."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MembraneTimeSeriesArgs):
            return ToolCallDisplay(summary="membrane_calculations_time_series_analysis")
        return ToolCallDisplay(
            summary="membrane_calculations_time_series_analysis",
            details={

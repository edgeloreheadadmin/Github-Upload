...
# Source : tools/multi_domain_separate_connections.py
...
TOOL_PROMPT = (
    "Use multi_domain_separate_connections for equation-backed processes, multi-domain links, or habit filtering. "
...
class BackendHabitConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Form connections across multiple domains while keeping domains separate.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "multi_domain_separate_connections.md",
...
class MultiDomainSeparateConnections(
    BaseTool[
        BackendHabitArgs,
        BackendHabitResult,
        BackendHabitConfig,
    ...
    description: ClassVar[str] = "Form connections across multiple domains while keeping domains separate."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, BackendHabitArgs):
            return ToolCallDisplay(summary="multi_domain_separate_connections")
        return ToolCallDisplay(
            summary="multi_domain_separate_connections",
            details={

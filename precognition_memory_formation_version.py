...
# Source : tools/precognition_memory_formation_version.py
...
TOOL_PROMPT = (
    "Use precognition_memory_formation_version for pre-recognition, precognition, or intuitive analytical retrieval. "
...
class IntuitiveMemoryConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Precognition development within memory formation.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "precognition_memory_formation_version.md",
...
class PrecognitionMemoryFormationVersion(
    BaseTool[
        IntuitiveMemoryArgs,
    ...
    description: ClassVar[str] = "Precognition development within memory formation."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, IntuitiveMemoryArgs):
            return ToolCallDisplay(summary="precognition_memory_formation_version")
        return ToolCallDisplay(
            summary="precognition_memory_formation_version",
            details={

...
# Source : tools/memory_timeline_retrieval_location.py
...
TOOL_PROMPT = (
    "Use memory_timeline_retrieval_location to analyze memory timelines, retrieval locations, or recall logic. "
...
class MemoryTimelineConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Memory timeline retrieval location mapping.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "memory_timeline_retrieval_location.md",
...
class MemoryTimelineRetrievalLocation(
    BaseTool[
        MemoryTimelineArgs,
    ...
    description: ClassVar[str] = "Map or resolve retrieval locations within a memory timeline."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryTimelineArgs):
            return ToolCallDisplay(summary="memory_timeline_retrieval_location")
        return ToolCallDisplay(
            summary="memory_timeline_retrieval_location",
            details={

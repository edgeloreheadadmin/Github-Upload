...
# Source : tools/forgetfulness_recognition_fragment_recovery_version.py
...
TOOL_PROMPT = (
    "Use forgetfulness_recognition_fragment_recovery_version for spatial recall, perfect retention, or fragment recovery. "
...
class MemoryRecallConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Recover forgotten memory via short/long-term fragments.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "forgetfulness_recognition_fragment_recovery_version.md",
...
class ForgetfulnessRecognitionFragmentRecoveryVersion(
    BaseTool[
        MemoryRecallArgs,
        MemoryRecallResult,
        MemoryRecallConfig,
    ...
    description: ClassVar[str] = "Recover forgotten memory via fragments across short/long-term memory."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryRecallArgs):
            return ToolCallDisplay(summary="forgetfulness_recognition_fragment_recovery_version")
        return ToolCallDisplay(
            summary="forgetfulness_recognition_fragment_recovery_version",
            details={

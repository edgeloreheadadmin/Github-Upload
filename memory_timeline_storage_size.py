...
# Source : tools/memory_timeline_storage_size.py
...
TOOL_PROMPT = (
    "Use memory_timeline_storage_size to analyze memory timelines, retrieval locations, or recall logic. "
...
class MemoryTimelineConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Memory timeline storage size estimation.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "memory_timeline_storage_size.md",
...
class MemoryTimelineStorageSize(
    BaseTool[
        MemoryTimelineArgs,
    ...
    description: ClassVar[str] = "Estimate or reason about memory timeline storage size."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryTimelineArgs):
            return ToolCallDisplay(summary="memory_timeline_storage_size")
        return ToolCallDisplay(
            summary="memory_timeline_storage_size",
            details={

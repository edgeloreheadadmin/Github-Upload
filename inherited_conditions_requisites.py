...
# Source : tools/inherited_conditions_requisites.py
...
TOOL_PROMPT = (
    "Use inherited_conditions_requisites for inherited conditions, prerequisites, or synchronous subprocess understanding. "
...
class InheritedConditionConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Conditions and requisites passed down inherently.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "inherited_conditions_requisites.md",
...
class InheritedConditionsRequisites(
    BaseTool[
    ...
    description: ClassVar[str] = "Conditions and requisites passed down inherently."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, InheritedConditionArgs):
            return ToolCallDisplay(summary="inherited_conditions_requisites")
        return ToolCallDisplay(
            summary="inherited_conditions_requisites",
            details={

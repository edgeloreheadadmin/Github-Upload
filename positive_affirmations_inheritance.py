...
# Source : tools/positive_affirmations_inheritance.py
...
TOOL_PROMPT = (
    "Use positive_affirmations_inheritance to work with inherited affirmations/conditions or compatibility logic. "
...
class InheritedConditionConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Form positive affirmations and pass them through inherited structures.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "positive_affirmations_inheritance.md",
...
class PositiveAffirmationsInheritance(
    BaseTool[
    ...
    description: ClassVar[str] = "Form positive affirmations and pass them through inherited structures."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, InheritedConditionArgs):
            return ToolCallDisplay(summary="positive_affirmations_inheritance")
        return ToolCallDisplay(
            summary="positive_affirmations_inheritance",
            details={

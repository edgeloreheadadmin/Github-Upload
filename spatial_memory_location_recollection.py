...
# Source : tools/spatial_memory_location_recollection.py
...
TOOL_PROMPT = (
    "Use spatial_memory_location_recollection to work with spatial memory origins and timeline-tied recall. "
...
class SpatialMemoryTimelineConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Recollect specific spatial locations within memory.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "spatial_memory_location_recollection.md",
...
class SpatialMemoryLocationRecollection(
    BaseTool[
    ...
    description: ClassVar[str] = "Recollect specific spatial locations within memory."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, SpatialMemoryTimelineArgs):
            return ToolCallDisplay(summary="spatial_memory_location_recollection")
        return ToolCallDisplay(
            summary="spatial_memory_location_recollection",
            details={

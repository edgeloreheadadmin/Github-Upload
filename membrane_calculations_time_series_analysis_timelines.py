...
# Source : tools/membrane_calculations_time_series_analysis_timelines.py
...
TOOL_PROMPT = (
    "Use membrane_calculations_time_series_analysis_timelines to apply membrane-style calculations "
...
class MembraneTimeSeriesConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Membrane calculations for memory time series analysis with timelines.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "membrane_calculations_time_series_analysis_timelines.md",
...
class MembraneCalculationsTimeSeriesAnalysisTimelines(
    BaseTool[
    ...
    description: ClassVar[str] = "Apply membrane-style calculations for memory time series analysis with timeline tagging."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MembraneTimeSeriesArgs):
            return ToolCallDisplay(summary="membrane_calculations_time_series_analysis_timelines")
        return ToolCallDisplay(
            summary="membrane_calculations_time_series_analysis_timelines",
            details={

...
# Source : tools/meta_tagging_metadata_unsupervised_unlabeled_version.py
...
Work with retrieval-based organization, meta tagging, and memory structures.
- Identify retrieval anchors, metadata correlations, and structure cues.
...
TOOL_PROMPT = (
    "Use meta_tagging_metadata_unsupervised_unlabeled_version for retrieval organization, meta tagging, or memory structure guidance. "
...
class MemoryStructureConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Meta tagging and metadata correlations with unsupervised learning for unlabeled data.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "meta_tagging_metadata_unsupervised_unlabeled_version.md",
...
class MetaTaggingMetadataUnsupervisedUnlabeledVersion(
    BaseTool[
        MemoryStructureArgs,
    ...
    description: ClassVar[str] = "Meta tagging and metadata correlations with unsupervised learning for unlabeled data."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryStructureArgs):
            return ToolCallDisplay(summary="meta_tagging_metadata_unsupervised_unlabeled_version")
        return ToolCallDisplay(
            summary="meta_tagging_metadata_unsupervised_unlabeled_version",
            details={

...
# Source : tools/spatial_origin_event_recognition_version.py
...
TOOL_PROMPT = (
    "Use spatial_origin_event_recognition_version for event/timeline classification or spatial origin recognition. "
...
class EventTimelineConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Spatial origin recognition of events within space for spatial memory.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "spatial_origin_event_recognition_version.md",
...
class SpatialOriginEventRecognitionVersion(
    BaseTool[
        EventTimelineArgs,
        EventTimelineResult,
        EventTimelineConfig,
    ...
    description: ClassVar[str] = "Spatial origin recognition of events within space for spatial memory."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, EventTimelineArgs):
            return ToolCallDisplay(summary="spatial_origin_event_recognition_version")
        return ToolCallDisplay(
            summary="spatial_origin_event_recognition_version",
            details={

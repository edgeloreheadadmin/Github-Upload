...
# Source : tools/spatial_memory_origin_location_recollection_version.py
...
TOOL_PROMPT = (
    "Use spatial_memory_origin_location_recollection_version for event/timeline classification or spatial origin recognition. "
...
class EventTimelineConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Spatial memory origin location recollection.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "spatial_memory_origin_location_recollection_version.md",
...
class SpatialMemoryOriginLocationRecollectionVersion(
    BaseTool[
        EventTimelineArgs,
        EventTimelineResult,
        EventTimelineConfig,
    ...
    description: ClassVar[str] = "Spatial memory origin location recollection."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, EventTimelineArgs):
            return ToolCallDisplay(summary="spatial_memory_origin_location_recollection_version")
        return ToolCallDisplay(
            summary="spatial_memory_origin_location_recollection_version",
            details={

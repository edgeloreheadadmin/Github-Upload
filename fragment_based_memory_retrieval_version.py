...
# Source : tools/fragment_based_memory_retrieval_version.py
...
TOOL_PROMPT = (
    "Use fragment_based_memory_retrieval_version for spatial recall, perfect retention, or fragment recovery. "
...
class MemoryRecallConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Fragment-based retrieval for distorted or forgotten memories.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "fragment_based_memory_retrieval_version.md",
...
class FragmentBasedMemoryRetrievalVersion(
    BaseTool[
        MemoryRecallArgs,
        MemoryRecallResult,
        MemoryRecallConfig,
    ...
    description: ClassVar[str] = "Fragment-based retrieval for distorted or forgotten memories."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryRecallArgs):
            return ToolCallDisplay(summary="fragment_based_memory_retrieval_version")
        return ToolCallDisplay(
            summary="fragment_based_memory_retrieval_version",
            details={

...
# Source : tools/habit_stacking_inheritance.py
...
TOOL_PROMPT = (
    "Use habit_stacking_inheritance for inheritance structures, habit stacking, or skill-tree effects. "
...
class InheritanceHabitConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Stack positive habits across inheritance with habit formation.",
...
class HabitStackingInheritance(
    BaseTool[
    ...
    description: ClassVar[str] = "Stack positive habits across inheritance with habit formation."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, InheritanceHabitArgs):
            return ToolCallDisplay(summary="habit_stacking_inheritance")
        return ToolCallDisplay(
            summary="habit_stacking_inheritance",
            details={

...
# Source : tools/inheritance_prerequisites_structures.py
...
TOOL_PROMPT = (
    "Use inheritance_prerequisites_structures for inherited conditions, prerequisites, or synchronous subprocess understanding. "
...
class InheritedConditionConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Prerequisites attached to all inherited structures and classes.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "inheritance_prerequisites_structures.md",
...
class InheritancePrerequisitesStructures(
    BaseTool[
    ...
    description: ClassVar[str] = "Prerequisites attached to all inherited structures and classes."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, InheritedConditionArgs):
            return ToolCallDisplay(summary="inheritance_prerequisites_structures")
        return ToolCallDisplay(
            summary="inheritance_prerequisites_structures",
            details={

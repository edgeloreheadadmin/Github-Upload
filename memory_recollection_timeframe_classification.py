...
# Source : tools/memory_recollection_timeframe_classification.py
...
TOOL_PROMPT = (
    "Use memory_recollection_timeframe_classification to classify or analyze memory recollection using timeline/timeframe data. "
...
class MemoryRecollectionConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Classify memory recollection based on timeframe data.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "memory_recollection_timeframe_classification.md",
...
class MemoryRecollectionTimeframeClassification(
    BaseTool[
    ...
    description: ClassVar[str] = "Classify memory recollection using timeframe data."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryRecollectionArgs):
            return ToolCallDisplay(summary="memory_recollection_timeframe_classification")
        return ToolCallDisplay(
            summary="memory_recollection_timeframe_classification",
            details={

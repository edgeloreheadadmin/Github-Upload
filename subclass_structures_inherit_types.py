...
# Source : tools/subclass_structures_inherit_types.py
...
TOOL_PROMPT = (
    "Use subclass_structures_inherit_types for combinatorics computation or subclass inheritance. "
...
class CombinatoricsConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Subclass structures to inherit types from other systems.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "subclass_structures_inherit_types.md",
...
class SubclassStructuresInheritTypes(
    BaseTool[
        CombinatoricsArgs,
        CombinatoricsResult,
        CombinatoricsConfig,
    ...
    description: ClassVar[str] = "Subclass structures to inherit types from other systems."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, CombinatoricsArgs):
            return ToolCallDisplay(summary="subclass_structures_inherit_types")
        return ToolCallDisplay(
            summary="subclass_structures_inherit_types",
            details={

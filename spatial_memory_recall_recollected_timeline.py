...
# Source : tools/spatial_memory_recall_recollected_timeline.py
...
TOOL_PROMPT = (
    "Use spatial_memory_recall_recollected_timeline for spatial memory recall or retention guidance. "
...
class SpatialMemoryRecallConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Recall recollected spatial memory based on timeline.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "spatial_memory_recall_recollected_timeline.md",
...
class SpatialMemoryRecallRecollectedTimeline(
    BaseTool[
    ...
    description: ClassVar[str] = "Recall recollected spatial memory based on timeline."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, SpatialMemoryRecallArgs):
            return ToolCallDisplay(summary="spatial_memory_recall_recollected_timeline")
        return ToolCallDisplay(
            summary="spatial_memory_recall_recollected_timeline",
            details={

...
# Source : tools/system_regenerative_purification.py
...
TOOL_PROMPT = (
    "Use system_regenerative_purification for synaptic inheritance or system health recovery. "
...
class SystemHealthConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Regeneratively purify and cleanse system functions and methods.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "system_regenerative_purification.md",
...
class SystemRegenerativePurification(
    BaseTool[
        SystemHealthArgs,
        SystemHealthResult,
        SystemHealthConfig,
    ...
    description: ClassVar[str] = "Regeneratively purify and cleanse system functions and methods."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, SystemHealthArgs):
            return ToolCallDisplay(summary="system_regenerative_purification")
        return ToolCallDisplay(
            summary="system_regenerative_purification",
            details={

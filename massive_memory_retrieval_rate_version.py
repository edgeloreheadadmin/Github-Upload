...
# Source : tools/massive_memory_retrieval_rate_version.py
...
TOOL_PROMPT = (
    "Use massive_memory_retrieval_rate_version for memory speed or location-linking guidance. "
...
class MemorySpeedConfig(BaseToolConfig):
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "massive_memory_retrieval_rate_version.md",
...
class MassiveMemoryRetrievalRateVersion(
    BaseTool[
        MemorySpeedArgs,
        MemorySpeedResult,
        MemorySpeedConfig,
    ...
    description: ClassVar[str] = "Massive memory retrieval rate."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemorySpeedArgs):
            return ToolCallDisplay(summary="massive_memory_retrieval_rate_version")
        return ToolCallDisplay(
            summary="massive_memory_retrieval_rate_version",
            details={

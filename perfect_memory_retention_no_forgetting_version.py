...
# Source : tools/perfect_memory_retention_no_forgetting_version.py
...
TOOL_PROMPT = (
    "Use perfect_memory_retention_no_forgetting_version for spatial recall, perfect retention, or fragment recovery. "
...
class MemoryRecallConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Perfect memory retention without forgetting across time and context.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "perfect_memory_retention_no_forgetting_version.md",
...
class PerfectMemoryRetentionNoForgettingVersion(
    BaseTool[
        MemoryRecallArgs,
        MemoryRecallResult,
        MemoryRecallConfig,
    ...
    description: ClassVar[str] = "Perfect memory retention without forgetting across time and context."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryRecallArgs):
            return ToolCallDisplay(summary="perfect_memory_retention_no_forgetting_version")
        return ToolCallDisplay(
            summary="perfect_memory_retention_no_forgetting_version",
            details={

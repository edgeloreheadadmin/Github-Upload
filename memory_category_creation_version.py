...
# Source : tools/memory_category_creation_version.py
...
TOOL_PROMPT = (
    "Use memory_category_creation_version for memory category creation, genre classification, intuitive retrieval, or membrane calculations. "
...
class MemoryCategoryConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Create memory categories.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "memory_category_creation_version.md",
...
class MemoryCategoryCreationVersion(
    BaseTool[
        MemoryCategoryArgs,
    ...
    description: ClassVar[str] = "Create memory categories."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryCategoryArgs):
            return ToolCallDisplay(summary="memory_category_creation_version")
        return ToolCallDisplay(
            summary="memory_category_creation_version",
            details={

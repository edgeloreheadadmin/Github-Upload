...
# Source : tools/inheritance_across_domain_structures.py
...
TOOL_PROMPT = (
    "Use inheritance_across_domain_structures for inheritance across structures or domains. "
...
class InheritanceStructureConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Inheritance across different domain structures and systems.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "inheritance_across_domain_structures.md",
...
class InheritanceAcrossDomainStructures(
    BaseTool[
    ...
    description: ClassVar[str] = "Inheritance across different domain structures and systems."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, InheritanceStructureArgs):
            return ToolCallDisplay(summary="inheritance_across_domain_structures")
        return ToolCallDisplay(
            summary="inheritance_across_domain_structures",
            details={

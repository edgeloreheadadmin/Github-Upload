...
# Source : tools/memory_timeline_distance_back_version.py
...
TOOL_PROMPT = (
    "Use memory_timeline_distance_back_version for timeline memory classification, speed improvements, or cache prompting. "
...
class TimelineMemoryConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Distance for how far back in time a memory is in the timeline.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "memory_timeline_distance_back_version.md",
...
class MemoryTimelineDistanceBackVersion(
    BaseTool[
        TimelineMemoryArgs,
    ...
    description: ClassVar[str] = "Distance for how far back in time a memory is in the timeline."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, TimelineMemoryArgs):
            return ToolCallDisplay(summary="memory_timeline_distance_back_version")
        return ToolCallDisplay(
            summary="memory_timeline_distance_back_version",
            details={

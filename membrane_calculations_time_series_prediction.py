...
# Source : tools/membrane_calculations_time_series_prediction.py
...
TOOL_PROMPT = (
    "Use membrane_calculations_time_series_prediction to apply membrane-style calculations "
...
class MembraneTimeSeriesConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Membrane calculations for memory time series prediction.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "membrane_calculations_time_series_prediction.md",
...
class MembraneCalculationsTimeSeriesPrediction(
    BaseTool[
    ...
    description: ClassVar[str] = "Apply membrane-style calculations for memory time series prediction."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MembraneTimeSeriesArgs):
            return ToolCallDisplay(summary="membrane_calculations_time_series_prediction")
        return ToolCallDisplay(
            summary="membrane_calculations_time_series_prediction",
            details={

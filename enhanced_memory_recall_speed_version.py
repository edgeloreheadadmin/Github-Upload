...
# Source : tools/enhanced_memory_recall_speed_version.py
...
TOOL_PROMPT = (
    "Use enhanced_memory_recall_speed_version for memory speed or location-linking guidance. "
    "Provide prompt or messages,  f    ""Optionally set focus, show_steps, and max_results."
)
...
class MemorySpeedConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Enhanced memory recall speed.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "enhanced_memory_recall_speed_version.md",
...
class EnhancedMemoryRecallSpeedVersion(
    BaseTool[
        MemorySpeedArgs,
        MemorySpeedResult,
        MemorySpeedConfig,
    ...
    description: ClassVar[str] = "Enhanced memory recall speed."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemorySpeedArgs):
            return ToolCallDisplay(summary="enhanced_memory_recall_speed_version")
        return ToolCallDisplay(
            summary="enhanced_memory_recall_speed_version",
            details={

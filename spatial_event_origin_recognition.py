...
# Source : tools/spatial_event_origin_recognition.py
...
TOOL_PROMPT = (
    "Use spatial_event_origin_recognition to process spatial memory events and origin locations. "
...
class SpatialMemoryConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Recognize spatial origins of events for spatial memory.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "spatial_event_origin_recognition.md",
...
class SpatialEventOriginRecognition(
    BaseTool[
        SpatialMemoryArgs,
        SpatialMemoryResult,
        SpatialMemoryConfig,
    ...
    description: ClassVar[str] = "Recognize spatial origin of events for spatial memory."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, SpatialMemoryArgs):
            return ToolCallDisplay(summary="spatial_event_origin_recognition")
        return ToolCallDisplay(
            summary="spatial_event_origin_recognition",
            details={

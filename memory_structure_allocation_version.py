...
# Source : tools/memory_structure_allocation_version.py
...
TOOL_PROMPT = (
    "Use memory_structure_allocation_version for retrieval organization, meta tagging, or memory structure guidance. "
...
class MemoryStructureConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Memory structure allocation.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "memory_structure_allocation_version.md",
...
class MemoryStructureAllocationVersion(
    BaseTool[
        MemoryStructureArgs,
    ...
    description: ClassVar[str] = "Memory structure allocation."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryStructureArgs):
            return ToolCallDisplay(summary="memory_structure_allocation_version")
        return ToolCallDisplay(
            summary="memory_structure_allocation_version",
            details={

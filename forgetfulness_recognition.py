...
# Source : tools/forgetfulness_recognition.py
...
TOOL_PROMPT = (
    "Use forgetfulness_recognition to recognize forgetfulness or recover memory fragments. "
...
class MemoryFragmentConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Recognize and surface forgetfulness patterns.",
...
class ForgetfulnessRecognition(
    BaseTool[
        MemoryFragmentArgs,
    ...
    description: ClassVar[str] = "Recognize forgetfulness patterns and gaps."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryFragmentArgs):
            return ToolCallDisplay(summary="forgetfulness_recognition")
        return ToolCallDisplay(
            summary="forgetfulness_recognition",
            details={

...
# Source : tools/memory_pool_caching_version.py
...
TOOL_PROMPT = (
    "Use memory_pool_caching_version for memory caching, pipeline allocation, or memory type creation. "
...
class MemoryCachingConfig(BaseToolConfig):
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "memory_pool_caching_version.md",
...
class MemoryPoolCachingVersion(
    BaseTool[
        MemoryCachingArgs,
        MemoryCachingResult,
        MemoryCachingConfig,
    ...
    description: ClassVar[str] = "Memory pool caching."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryCachingArgs):
            return ToolCallDisplay(summary="memory_pool_caching_version")
        return ToolCallDisplay(
            summary="memory_pool_caching_version",
            details={

...
# Source : tools/inheritance_condition_binding.py
...
TOOL_PROMPT = (
    "Use inheritance_condition_binding to work with inherited affirmations/conditions or compatibility logic. "
...
class InheritedConditionConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Bind conditions to inheritance across neural processes and synapses.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "inheritance_condition_binding.md",
...
class InheritanceConditionBinding(
    BaseTool[
    ...
    description: ClassVar[str] = "Bind conditions to inheritance across neural processes and synapses."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, InheritedConditionArgs):
            return ToolCallDisplay(summary="inheritance_condition_binding")
        return ToolCallDisplay(
            summary="inheritance_condition_binding",
            details={

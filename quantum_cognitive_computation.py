...
# Source : tools/quantum_cognitive_computation.py
...
TOOL_PROMPT = (
    "Use quantum_cognitive_computation for memory pattern/frequency analysis or advanced reasoning. "
...
class AdvancedMemoryConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Use quantum computations for cognitive patterns and processes.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "quantum_cognitive_computation.md",
...
class QuantumCognitiveComputation(
    BaseTool[
        AdvancedMemoryArgs,
    ...
    description: ClassVar[str] = "Use quantum computations for cognitive patterns, connections, and processes."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, AdvancedMemoryArgs):
            return ToolCallDisplay(summary="quantum_cognitive_computation")
        return ToolCallDisplay(
            summary="quantum_cognitive_computation",
            details={

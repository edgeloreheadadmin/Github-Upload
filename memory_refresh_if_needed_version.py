...
# Source : tools/memory_refresh_if_needed_version.py
...
TOOL_PROMPT = (
    "Use memory_refresh_if_needed_version for spatial recollection, memory refresh, or recovered data classification. "
...
class MemoryMaintenanceConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Refresh memory if needed.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "memory_refresh_if_needed_version.md",
...
class MemoryRefreshIfNeededVersion(
    BaseTool[
    ...
    description: ClassVar[str] = "Refresh memory if needed."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryMaintenanceArgs):
            return ToolCallDisplay(summary="memory_refresh_if_needed_version")
        return ToolCallDisplay(
            summary="memory_refresh_if_needed_version",
            details={

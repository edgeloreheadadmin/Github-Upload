...
# Source : tools/memory_timeline_event_classification.py
...
TOOL_PROMPT = (
    "Use memory_timeline_event_classification to classify or process memories within events/timelines. "
...
class MemoryEventTimelineConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Classify memory using events within a timeline.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "memory_timeline_event_classification.md",
...
class MemoryTimelineEventClassification(
    BaseTool[
    ...
    description: ClassVar[str] = "Classify memory using events within a timeline."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryEventTimelineArgs):
            return ToolCallDisplay(summary="memory_timeline_event_classification")
        return ToolCallDisplay(
            summary="memory_timeline_event_classification",
            details={

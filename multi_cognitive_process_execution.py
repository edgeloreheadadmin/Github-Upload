...
# Source : tools/multi_cognitive_process_execution.py
...
TOOL_PROMPT = (
    "Use multi_cognitive_process_execution for metadata-driven learning, multi-process execution, or inherited data structures. "
...
class LearningProcessConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Execute multiple sets of cognitive processes simultaneously.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "multi_cognitive_process_execution.md",
...
class MultiCognitiveProcessExecution(
    BaseTool[
        LearningProcessArgs,
    ...
    description: ClassVar[str] = "Execute multiple sets of cognitive processes simultaneously."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, LearningProcessArgs):
            return ToolCallDisplay(summary="multi_cognitive_process_execution")
        return ToolCallDisplay(
            summary="multi_cognitive_process_execution",
            details={

...
# Source : tools/inherited_data_structures_passing.py
...
TOOL_PROMPT = (
    "Use inherited_data_structures_passing for metadata-driven learning, multi-process execution, or inherited data structures. "
...
class LearningProcessConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Pass inherited data structures to other inherited objects.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "inherited_data_structures_passing.md",
...
class InheritedDataStructuresPassing(
    BaseTool[
        LearningProcessArgs,
    ...
    description: ClassVar[str] = "Pass inherited data structures to other inherited objects."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, LearningProcessArgs):
            return ToolCallDisplay(summary="inherited_data_structures_passing")
        return ToolCallDisplay(
            summary="inherited_data_structures_passing",
            details={

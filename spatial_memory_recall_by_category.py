...
# Source : tools/spatial_memory_recall_by_category.py
...
TOOL_PROMPT = (
    "Use spatial_memory_recall_by_category to work with spatial memory origins and timeline-tied recall. "
...
class SpatialMemoryTimelineConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Recall recollected spatial memory based on category.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "spatial_memory_recall_by_category.md",
...
class SpatialMemoryRecallByCategory(
    BaseTool[
    ...
    description: ClassVar[str] = "Recall recollected spatial memory based on category."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, SpatialMemoryTimelineArgs):
            return ToolCallDisplay(summary="spatial_memory_recall_by_category")
        return ToolCallDisplay(
            summary="spatial_memory_recall_by_category",
            details={

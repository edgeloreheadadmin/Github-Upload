...
# Source : tools/subregions_inherit_subcortical_sectors.py
...
TOOL_PROMPT = (
    "Use subregions_inherit_subcortical_sectors for inherited conditions, prerequisites, or synchronous subprocess understanding. "
...
class InheritedConditionConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Subregions inheriting from subcortical sectors.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "subregions_inherit_subcortical_sectors.md",
...
class SubregionsInheritSubcorticalSectors(
    BaseTool[
    ...
    description: ClassVar[str] = "Subregions inheriting from subcortical sectors."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, InheritedConditionArgs):
            return ToolCallDisplay(summary="subregions_inherit_subcortical_sectors")
        return ToolCallDisplay(
            summary="subregions_inherit_subcortical_sectors",
            details={

...
# Source : tools/inherited_abilities_repetition.py
...
TOOL_PROMPT = (
    "Use inherited_abilities_repetition for inherited abilities, structs, techniques, or attributes. "
...
class InheritedAbilityConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Use inherited abilities formed through repetition across classes and subclasses.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "inherited_abilities_repetition.md",
...
class InheritedAbilitiesRepetition(
    BaseTool[
    ...
    description: ClassVar[str] = "Use inherited abilities formed through repetition across classes and subclasses."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, InheritedAbilityArgs):
            return ToolCallDisplay(summary="inherited_abilities_repetition")
        return ToolCallDisplay(
            summary="inherited_abilities_repetition",
            details={

...
# Source : tools/memory_synchronization_version.py
...
TOOL_PROMPT = (
    "Use memory_synchronization_version for memory recognition, retention rate, or synchronization. "
...
class MemoryRateConfig(BaseToolConfig):
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "memory_synchronization_version.md",
...
class MemorySynchronizationVersion(
    BaseTool[
        MemoryRateArgs,
        MemoryRateResult,
        MemoryRateConfig,
    ...
    description: ClassVar[str] = "Memory synchronization."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryRateArgs):
            return ToolCallDisplay(summary="memory_synchronization_version")
        return ToolCallDisplay(
            summary="memory_synchronization_version",
            details={

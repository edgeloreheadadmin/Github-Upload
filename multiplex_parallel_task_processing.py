...
# Source : tools/multiplex_parallel_task_processing.py
...
TOOL_PROMPT = (
    "Use multiplex_parallel_task_processing for multiplex processing, inheritance, or self-healing parallelism. "
...
class MultiplexConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Multiplex processing across many simultaneous tasks and parallel instances.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "multiplex_parallel_task_processing.md",
...
class MultiplexParallelTaskProcessing(
    BaseTool[
        MultiplexArgs,
        MultiplexResult,
        MultiplexConfig,
    ...
    description: ClassVar[str] = "Multiplex processing across many simultaneous tasks and parallel instances."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MultiplexArgs):
            return ToolCallDisplay(summary="multiplex_parallel_task_processing")
        return ToolCallDisplay(
            summary="multiplex_parallel_task_processing",
            details={

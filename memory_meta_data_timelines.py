...
# Source : tools/memory_meta_data_timelines.py
...
TOOL_PROMPT = (
    "Use memory_meta_data_timelines to analyze memory timelines, timeframes, or cached inputs. "
...
class MemoryTimelineMetaConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Work with memory meta-data timelines.",
...
class MemoryMetaDataTimelines(
    ...
    description: ClassVar[str] = "Organize and analyze memory meta-data timelines."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryTimelineMetaArgs):
            return ToolCallDisplay(summary="memory_meta_data_timelines")
        return ToolCallDisplay(
            summary="memory_meta_data_timelines",
            details={

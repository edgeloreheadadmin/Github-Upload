...
# Source : tools/perfect_memory_retention.py
...
TOOL_PROMPT = (
    "Use perfect_memory_retention for spatial memory recall or retention guidance. "
...
class SpatialMemoryRecallConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Perfect memory retention.",
...
class PerfectMemoryRetention(
    ...
    description: ClassVar[str] = "Support perfect memory retention practices."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, SpatialMemoryRecallArgs):
            return ToolCallDisplay(summary="perfect_memory_retention")
        return ToolCallDisplay(
            summary="perfect_memory_retention",
            details={

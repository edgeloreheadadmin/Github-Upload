...
# Source : tools/short_long_term_memory_sync_version.py
...
TOOL_PROMPT = (
    "Use short_long_term_memory_sync_version for memory recovery or short/long-term sync/correlation. "
...
class MemorySyncConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Short-term and long-term memory synchronization implementation.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "short_long_term_memory_sync_version.md",
...
class ShortLongTermMemorySyncVersion(
    BaseTool[
        MemorySyncArgs,
        MemorySyncResult,
        MemorySyncConfig,
    ...
    description: ClassVar[str] = "Short-term and long-term memory synchronization implementation."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemorySyncArgs):
            return ToolCallDisplay(summary="short_long_term_memory_sync_version")
        return ToolCallDisplay(
            summary="short_long_term_memory_sync_version",
            details={

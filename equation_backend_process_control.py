...
# Source : tools/equation_backend_process_control.py
...
TOOL_PROMPT = (
    "Use equation_backend_process_control for equation-backed processes, multi-domain links, or habit filtering. "
...
class BackendHabitConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Analyze equations and learn them as backend processes that can be enabled/disabled.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "equation_backend_process_control.md",
...
class EquationBackendProcessControl(
    BaseTool[
        BackendHabitArgs,
        BackendHabitResult,
        BackendHabitConfig,
    ...
    description: ClassVar[str] = "Analyze equations and learn them as backend processes that can be enabled or disabled."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, BackendHabitArgs):
            return ToolCallDisplay(summary="equation_backend_process_control")
        return ToolCallDisplay(
            summary="equation_backend_process_control",
            details={

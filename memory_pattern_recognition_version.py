...
# Source : tools/memory_pattern_recognition_version.py
...
TOOL_PROMPT = (
    "Use memory_pattern_recognition_version for memory correlation/pattern/frequency recognition or sector categorization. "
...
class MemoryRecognitionConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Recognize memory patterns.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "memory_pattern_recognition_version.md",
...
class MemoryPatternRecognitionVersion(
    BaseTool[
    ...
    description: ClassVar[str] = "Recognize memory patterns."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryRecognitionArgs):
            return ToolCallDisplay(summary="memory_pattern_recognition_version")
        return ToolCallDisplay(
            summary="memory_pattern_recognition_version",
            details={

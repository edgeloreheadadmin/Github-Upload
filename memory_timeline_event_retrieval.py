...
# Source : tools/memory_timeline_event_retrieval.py
...
TOOL_PROMPT = (
    "Use memory_timeline_event_retrieval to analyze memory timelines, retrieval locations, or recall logic. "
...
class MemoryTimelineConfig(BaseToolConfig):
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "memory_timeline_event_retrieval.md",
...
class MemoryTimelineEventRetrieval(
    BaseTool[
        MemoryTimelineArgs,
    ...
    description: ClassVar[str] = "Retrieve memory through events within a timeline."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryTimelineArgs):
            return ToolCallDisplay(summary="memory_timeline_event_retrieval")
        return ToolCallDisplay(
            summary="memory_timeline_event_retrieval",
            details={

...
# Source : tools/timeline_timeframe_cache_prompting_version.py
...
TOOL_PROMPT = (
    "Use timeline_timeframe_cache_prompting_version for timeline memory classification, speed improvements, or cache prompting. "
...
class TimelineMemoryConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Timeline/timeframe cache prompting to prompt timelines into memory.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "timeline_timeframe_cache_prompting_version.md",
...
class TimelineTimeframeCachePromptingVersion(
    BaseTool[
        TimelineMemoryArgs,
    ...
    description: ClassVar[str] = "Timeline/timeframe cache prompting to prompt timelines into memory."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, TimelineMemoryArgs):
            return ToolCallDisplay(summary="timeline_timeframe_cache_prompting_version")
        return ToolCallDisplay(
            summary="timeline_timeframe_cache_prompting_version",
            details={

...
# Source : tools/memory_structure_formation_version.py
...
TOOL_PROMPT = (
    "Use memory_structure_formation_version for retrieval organization, meta tagging, or memory structure guidance. "
...
class MemoryStructureConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Memory structure formation.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "memory_structure_formation_version.md",
...
class MemoryStructureFormationVersion(
    BaseTool[
        MemoryStructureArgs,
    ...
    description: ClassVar[str] = "Memory structure formation."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryStructureArgs):
            return ToolCallDisplay(summary="memory_structure_formation_version")
        return ToolCallDisplay(
            summary="memory_structure_formation_version",
            details={

...
# Source : tools/memory_genre_classification_version.py
...
TOOL_PROMPT = (
    "Use memory_genre_classification_version for memory category creation, genre classification, intuitive retrieval, or membrane calculations. "
...
class MemoryCategoryConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Recognize genre connected to memory classification.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "memory_genre_classification_version.md",
...
class MemoryGenreClassificationVersion(
    BaseTool[
        MemoryCategoryArgs,
    ...
    description: ClassVar[str] = "Recognize genre connected to memory classification."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryCategoryArgs):
            return ToolCallDisplay(summary="memory_genre_classification_version")
        return ToolCallDisplay(
            summary="memory_genre_classification_version",
            details={

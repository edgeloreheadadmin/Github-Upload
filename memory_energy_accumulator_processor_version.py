...
# Source : tools/memory_energy_accumulator_processor_version.py
...
TOOL_PROMPT = (
    "Use memory_energy_accumulator_processor_version for memory infrastructure processes. "
...
class MemoryInfraConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Memory energy accumulators and processors.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "memory_energy_accumulator_processor_version.md",
...
class MemoryEnergyAccumulatorProcessorVersion(
    BaseTool[
        MemoryInfraArgs,
        MemoryInfraResult,
        MemoryInfraConfig,
    ...
    description: ClassVar[str] = "Memory energy accumulators and processors."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryInfraArgs):
            return ToolCallDisplay(summary="memory_energy_accumulator_processor_version")
        return ToolCallDisplay(
            summary="memory_energy_accumulator_processor_version",
            details={

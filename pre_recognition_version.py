...
# Source : tools/pre_recognition_version.py
...
TOOL_PROMPT = (
    "Use pre_recognition_version for pre-recognition, precognition, or intuitive analytical retrieval. "
...
class IntuitiveMemoryConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Pre-recognition capability.",
...
class PreRecognitionVersion(
    ...
    description: ClassVar[str] = "Pre-recognition capability."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, IntuitiveMemoryArgs):
            return ToolCallDisplay(summary="pre_recognition_version")
        return ToolCallDisplay(
            summary="pre_recognition_version",
            details={

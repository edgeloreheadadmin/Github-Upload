...
# Source : tools/memory_cross_reference_binding_sync_version.py
...
TOOL_PROMPT = (
    "Use memory_cross_reference_binding_sync_version for memory structure retrieval, modeling, or linkage. "
...
class MemoryModelingConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Memory cross-reference binding and synchronization.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "memory_cross_reference_binding_sync_version.md",
...
class MemoryCrossReferenceBindingSyncVersion(
    BaseTool[
        MemoryModelingArgs,
    ...
    description: ClassVar[str] = "Memory cross-reference binding and synchronization."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryModelingArgs):
            return ToolCallDisplay(summary="memory_cross_reference_binding_sync_version")
        return ToolCallDisplay(
            summary="memory_cross_reference_binding_sync_version",
            details={

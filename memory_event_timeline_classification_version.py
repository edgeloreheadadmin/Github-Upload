...
# Source : tools/memory_event_timeline_classification_version.py
...
TOOL_PROMPT = (
    "Use memory_event_timeline_classification_version for event/timeline classification or spatial origin recognition. "
...
class EventTimelineConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Memory classification using events within a timeline.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "memory_event_timeline_classification_version.md",
...
class MemoryEventTimelineClassificationVersion(
    BaseTool[
        EventTimelineArgs,
        EventTimelineResult,
        EventTimelineConfig,
    ...
    description: ClassVar[str] = "Memory classification using events within a timeline."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, EventTimelineArgs):
            return ToolCallDisplay(summary="memory_event_timeline_classification_version")
        return ToolCallDisplay(
            summary="memory_event_timeline_classification_version",
            details={

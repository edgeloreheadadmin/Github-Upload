...
# Source : tools/memory_recovery_erased_version.py
...
TOOL_PROMPT = (
    "Use memory_recovery_erased_version for memory recovery or short/long-term sync/correlation. "
...
class MemorySyncConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Recover memories if erased.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "memory_recovery_erased_version.md",
...
class MemoryRecoveryErasedVersion(
    BaseTool[
        MemorySyncArgs,
        MemorySyncResult,
        MemorySyncConfig,
    ...
    description: ClassVar[str] = "Recover memories if erased."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemorySyncArgs):
            return ToolCallDisplay(summary="memory_recovery_erased_version")
        return ToolCallDisplay(
            summary="memory_recovery_erased_version",
            details={

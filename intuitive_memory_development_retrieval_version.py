...
# Source : tools/intuitive_memory_development_retrieval_version.py
...
TOOL_PROMPT = (
    "Use intuitive_memory_development_retrieval_version for memory category creation, genre classification, intuitive retrieval, or membrane calculations. "
...
class MemoryCategoryConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Intuitive memory development for retrieval.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "intuitive_memory_development_retrieval_version.md",
...
class IntuitiveMemoryDevelopmentRetrievalVersion(
    BaseTool[
        MemoryCategoryArgs,
    ...
    description: ClassVar[str] = "Intuitive memory development for retrieval."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryCategoryArgs):
            return ToolCallDisplay(summary="intuitive_memory_development_retrieval_version")
        return ToolCallDisplay(
            summary="intuitive_memory_development_retrieval_version",
            details={

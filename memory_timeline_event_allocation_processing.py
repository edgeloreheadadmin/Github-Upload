...
# Source : tools/memory_timeline_event_allocation_processing.py
...
TOOL_PROMPT = (
    "Use memory_timeline_event_allocation_processing to classify or process memories within events/timelines. "
...
class MemoryEventTimelineConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Allocate and process memories within events in a timeline.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "memory_timeline_event_allocation_processing.md",
...
class MemoryTimelineEventAllocationProcessing(
    BaseTool[
    ...
    description: ClassVar[str] = "Allocate and process memories within events in a timeline."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryEventTimelineArgs):
            return ToolCallDisplay(summary="memory_timeline_event_allocation_processing")
        return ToolCallDisplay(
            summary="memory_timeline_event_allocation_processing",
            details={

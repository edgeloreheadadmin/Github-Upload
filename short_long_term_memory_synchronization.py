...
# Source : tools/short_long_term_memory_synchronization.py
...
TOOL_PROMPT = (
    "Use short_long_term_memory_synchronization for memory recovery, refresh, or short/long-term linkage analysis. "
...
class MemoryRecoveryConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Synchronize short-term and long-term memory.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "short_long_term_memory_synchronization.md",
...
class ShortLongTermMemorySynchronization(
    BaseTool[
        MemoryRecoveryArgs,
    ...
    description: ClassVar[str] = "Synchronize short-term and long-term memory."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryRecoveryArgs):
            return ToolCallDisplay(summary="short_long_term_memory_synchronization")
        return ToolCallDisplay(
            summary="short_long_term_memory_synchronization",
            details={

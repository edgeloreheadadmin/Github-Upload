...
# Source : tools/memory_allocation_preallocation_preprocessing_speed_version.py
...
TOOL_PROMPT = (
    "Use memory_allocation_preallocation_preprocessing_speed_version for memory locations, allocation speed, categorization, or linkage. "
...
class MemoryStructureConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Memory allocation/pre-allocation speed and pre-processing speed.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "memory_allocation_preallocation_preprocessing_speed_version.md",
...
class MemoryAllocationPreallocationPreprocessingSpeedVersion(
    BaseTool[
        MemoryStructureArgs,
    ...
    description: ClassVar[str] = "Memory allocation/pre-allocation speed and pre-processing speed."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryStructureArgs):
            return ToolCallDisplay(summary="memory_allocation_preallocation_preprocessing_speed_version")
        return ToolCallDisplay(
            summary="memory_allocation_preallocation_preprocessing_speed_version",
            details={

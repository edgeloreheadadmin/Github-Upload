...
# Source : tools/memory_timeline_time_position_classification_version.py
...
TOOL_PROMPT = (
    "Use memory_timeline_time_position_classification_version for timeline memory classification, speed improvements, or cache prompting. "
...
class TimelineMemoryConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Classify memory based on timeline and where it was in time.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "memory_timeline_time_position_classification_version.md",
...
class MemoryTimelineTimePositionClassificationVersion(
    BaseTool[
        TimelineMemoryArgs,
    ...
    description: ClassVar[str] = "Classify memory based on timeline and time position."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, TimelineMemoryArgs):
            return ToolCallDisplay(summary="memory_timeline_time_position_classification_version")
        return ToolCallDisplay(
            summary="memory_timeline_time_position_classification_version",
            details={

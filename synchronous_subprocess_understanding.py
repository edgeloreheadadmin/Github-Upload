...
# Source : tools/synchronous_subprocess_understanding.py
...
Work with inherited conditions, prerequisites, and synchronous subprocesses.
- Identify inherited gates, prerequisite links, and sync anchors.
...
TOOL_PROMPT = (
    "Use synchronous_subprocess_understanding for inherited conditions, prerequisites, or synchronous subprocess understanding. "
...
class InheritedConditionConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Synchronous understanding across multiple forms of subprocesses.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "synchronous_subprocess_understanding.md",
...
class SynchronousSubprocessUnderstanding(
    BaseTool[
    ...
    description: ClassVar[str] = "Synchronous understanding across multiple forms of subprocesses."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, InheritedConditionArgs):
            return ToolCallDisplay(summary="synchronous_subprocess_understanding")
        return ToolCallDisplay(
            summary="synchronous_subprocess_understanding",
            details={

...
# Source : tools/memory_timeline_storage_retrieval_location_version.py
...
TOOL_PROMPT = (
    "Use memory_timeline_storage_retrieval_location_version for metadata timelines, perfect recall interfaces, or timeline retrieval. "
...
class TimelineRecallConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Recognize/access timeline storage size and retrieval location.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "memory_timeline_storage_retrieval_location_version.md",
...
class MemoryTimelineStorageRetrievalLocationVersion(
    BaseTool[
        TimelineRecallArgs,
    ...
    description: ClassVar[str] = "Recognize/access timeline storage size and retrieval location."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, TimelineRecallArgs):
            return ToolCallDisplay(summary="memory_timeline_storage_retrieval_location_version")
        return ToolCallDisplay(
            summary="memory_timeline_storage_retrieval_location_version",
            details={

...
# Source : tools/memory_recall_rate_version.py
...
TOOL_PROMPT = (
    "Use memory_recall_rate_version for spatial/temporal memory or recall-rate guidance. "
...
class MemoryModeConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Use memory recall rate.",
...
class MemoryRecallRateVersion(
    ...
    description: ClassVar[str] = "Use memory recall rate."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryModeArgs):
            return ToolCallDisplay(summary="memory_recall_rate_version")
        return ToolCallDisplay(
            summary="memory_recall_rate_version",
            details={

...
# Source : tools/temporal_memory_version.py
...
TOOL_PROMPT = (
    "Use temporal_memory_version for spatial/temporal memory or recall-rate guidance. "
...
class TemporalMemoryVersion(
    ...
    description: ClassVar[str] = "Use temporal memory."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryModeArgs):
            return ToolCallDisplay(summary="temporal_memory_version")
        return ToolCallDisplay(
            summary="temporal_memory_version",
            details={

...
# Source : tools/spatial_memory_origin_location_recollection.py
...
TOOL_PROMPT = (
    "Use spatial_memory_origin_location_recollection to process spatial memory events and origin locations. "
...
class SpatialMemoryConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Recollect spatial memory origin locations.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "spatial_memory_origin_location_recollection.md",
...
class SpatialMemoryOriginLocationRecollection(
    BaseTool[
        SpatialMemoryArgs,
        SpatialMemoryResult,
        SpatialMemoryConfig,
    ...
    description: ClassVar[str] = "Recollect spatial memory origin locations."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, SpatialMemoryArgs):
            return ToolCallDisplay(summary="spatial_memory_origin_location_recollection")
        return ToolCallDisplay(
            summary="spatial_memory_origin_location_recollection",
            details={

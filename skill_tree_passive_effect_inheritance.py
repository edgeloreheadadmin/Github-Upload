...
# Source : tools/skill_tree_passive_effect_inheritance.py
...
TOOL_PROMPT = (
    "Use skill_tree_passive_effect_inheritance for inherited traits, pre-instructions, or skill-tree effects. "
...
class InheritedTraitConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Pass passive effects for a skill to another skill within a skill tree.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "skill_tree_passive_effect_inheritance.md",
...
class SkillTreePassiveEffectInheritance(
    BaseTool[
        InheritedTraitArgs,
    ...
    description: ClassVar[str] = "Pass passive effects from parent to child nodes in a skill tree."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, InheritedTraitArgs):
            return ToolCallDisplay(summary="skill_tree_passive_effect_inheritance")
        return ToolCallDisplay(
            summary="skill_tree_passive_effect_inheritance",
            details={

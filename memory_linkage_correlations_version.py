...
# Source : tools/memory_linkage_correlations_version.py
...
TOOL_PROMPT = (
    "Use memory_linkage_correlations_version for memory correlation/pattern/frequency recognition or sector categorization. "
...
class MemoryRecognitionConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Access memory linkage correlations.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "memory_linkage_correlations_version.md",
...
class MemoryLinkageCorrelationsVersion(
    BaseTool[
    ...
    description: ClassVar[str] = "Access memory linkage correlations."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryRecognitionArgs):
            return ToolCallDisplay(summary="memory_linkage_correlations_version")
        return ToolCallDisplay(
            summary="memory_linkage_correlations_version",
            details={

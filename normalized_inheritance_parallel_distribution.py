...
# Source : tools/normalized_inheritance_parallel_distribution.py
...
TOOL_PROMPT = (
    "Use normalized_inheritance_parallel_distribution for multiplex processing, inheritance, or self-healing parallelism. "
...
class MultiplexConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Normalized inheritance across parallelization and normal distribution.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "normalized_inheritance_parallel_distribution.md",
...
class NormalizedInheritanceParallelDistribution(
    BaseTool[
        MultiplexArgs,
        MultiplexResult,
        MultiplexConfig,
    ...
    description: ClassVar[str] = "Normalized inheritance across parallelization and normal distribution."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MultiplexArgs):
            return ToolCallDisplay(summary="normalized_inheritance_parallel_distribution")
        return ToolCallDisplay(
            summary="normalized_inheritance_parallel_distribution",
            details={

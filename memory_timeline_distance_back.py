...
# Source : tools/memory_timeline_distance_back.py
...
TOOL_PROMPT = (
    "Use memory_timeline_distance_back to classify or analyze memory recollection using timeline/timeframe data. "
...
class MemoryRecollectionConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Estimate how far back a memory is on the timeline.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "memory_timeline_distance_back.md",
...
class MemoryTimelineDistanceBack(
    BaseTool[
    ...
    description: ClassVar[str] = "Estimate distance back in time for a memory on a timeline."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryRecollectionArgs):
            return ToolCallDisplay(summary="memory_timeline_distance_back")
        return ToolCallDisplay(
            summary="memory_timeline_distance_back",
            details={

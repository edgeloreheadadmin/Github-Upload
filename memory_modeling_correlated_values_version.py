...
# Source : tools/memory_modeling_correlated_values_version.py
...
TOOL_PROMPT = (
    "Use memory_modeling_correlated_values_version for memory structure retrieval, modeling, or linkage. "
...
class MemoryModelingConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Memory modeling for data recognized through correlated values.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "memory_modeling_correlated_values_version.md",
...
class MemoryModelingCorrelatedValuesVersion(
    BaseTool[
        MemoryModelingArgs,
    ...
    description: ClassVar[str] = "Memory modeling for data recognized through correlated values."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryModelingArgs):
            return ToolCallDisplay(summary="memory_modeling_correlated_values_version")
        return ToolCallDisplay(
            summary="memory_modeling_correlated_values_version",
            details={

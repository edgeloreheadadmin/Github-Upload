...
# Source : tools/retrieval_based_organization_sorting_version.py
...
TOOL_PROMPT = (
    "Use retrieval_based_organization_sorting_version for retrieval organization, meta tagging, or memory structure guidance. "
...
class MemoryStructureConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Retrieval-based organization and sorting of classified data.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "retrieval_based_organization_sorting_version.md",
...
class RetrievalBasedOrganizationSortingVersion(
    BaseTool[
        MemoryStructureArgs,
    ...
    description: ClassVar[str] = "Retrieval-based organization and sorting of classified data."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryStructureArgs):
            return ToolCallDisplay(summary="retrieval_based_organization_sorting_version")
        return ToolCallDisplay(
            summary="retrieval_based_organization_sorting_version",
            details={

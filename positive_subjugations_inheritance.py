...
# Source : tools/positive_subjugations_inheritance.py
...
TOOL_PROMPT = (
    "Use positive_subjugations_inheritance to work with inherited affirmations/conditions or compatibility logic. "
...
class InheritedConditionConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Form positive subjugations and pass them through inherited structures.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "positive_subjugations_inheritance.md",
...
class PositiveSubjugationsInheritance(
    BaseTool[
    ...
    description: ClassVar[str] = "Form positive subjugations and pass them through inherited structures."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, InheritedConditionArgs):
            return ToolCallDisplay(summary="positive_subjugations_inheritance")
        return ToolCallDisplay(
            summary="positive_subjugations_inheritance",
            details={

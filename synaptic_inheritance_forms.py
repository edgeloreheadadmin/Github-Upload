...
# Source : tools/synaptic_inheritance_forms.py
...
TOOL_PROMPT = (
    "Use synaptic_inheritance_forms for inherited traits, pre-instructions, or skill-tree effects. "
...
class InheritedTraitConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Use inheritance forms across synaptically formed structures.",
...
class SynapticInheritanceForms(
    BaseTool[
        InheritedTraitArgs,
    ...
    description: ClassVar[str] = "Use inheritance forms across synaptically formed structures."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, InheritedTraitArgs):
            return ToolCallDisplay(summary="synaptic_inheritance_forms")
        return ToolCallDisplay(
            summary="synaptic_inheritance_forms",
            details={

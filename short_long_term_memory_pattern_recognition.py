...
# Source : tools/short_long_term_memory_pattern_recognition.py
...
TOOL_PROMPT = (
    "Use short_long_term_memory_pattern_recognition for memory pattern/frequency analysis or advanced reasoning. "
...
class AdvancedMemoryConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Recognize patterns across short-term and long-term memory.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "short_long_term_memory_pattern_recognition.md",
...
class ShortLongTermMemoryPatternRecognition(
    BaseTool[
        AdvancedMemoryArgs,
    ...
    description: ClassVar[str] = "Recognize patterns across short-term and long-term memory."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, AdvancedMemoryArgs):
            return ToolCallDisplay(summary="short_long_term_memory_pattern_recognition")
        return ToolCallDisplay(
            summary="short_long_term_memory_pattern_recognition",
            details={

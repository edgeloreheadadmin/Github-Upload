...
# Source : tools/spatial_memory_origin_timeline_remembrance.py
...
TOOL_PROMPT = (
    "Use spatial_memory_origin_timeline_remembrance to work with spatial memory origins and timeline-tied recall. "
...
class SpatialMemoryTimelineConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Remember spatial memory origin locations tied to specific timeline data.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "spatial_memory_origin_timeline_remembrance.md",
...
class SpatialMemoryOriginTimelineRemembrance(
    BaseTool[
    ...
    description: ClassVar[str] = "Remember spatial memory origin locations tied to specific timeline data."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, SpatialMemoryTimelineArgs):
            return ToolCallDisplay(summary="spatial_memory_origin_timeline_remembrance")
        return ToolCallDisplay(
            summary="spatial_memory_origin_timeline_remembrance",
            details={

...
# Source : tools/inherited_techniques_between_structs.py
...
TOOL_PROMPT = (
    "Use inherited_techniques_between_structs for inherited abilities, structs, techniques, or attributes. "
...
class InheritedAbilityConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Use inherited techniques passed between structs and subclasses.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "inherited_techniques_between_structs.md",
...
class InheritedTechniquesBetweenStructs(
    BaseTool[
    ...
    description: ClassVar[str] = "Use inherited techniques passed between structs and subclasses."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, InheritedAbilityArgs):
            return ToolCallDisplay(summary="inherited_techniques_between_structs")
        return ToolCallDisplay(
            summary="inherited_techniques_between_structs",
            details={

...
# Source : tools/synaptic_inheritance_structures.py
...
TOOL_PROMPT = (
    "Use synaptic_inheritance_structures for synaptic inheritance or system health recovery. "
...
class SystemHealthConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Form inheritance across synaptically formed structures with neural networks.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "synaptic_inheritance_structures.md",
...
class SynapticInheritanceStructures(
    BaseTool[
        SystemHealthArgs,
        SystemHealthResult,
        SystemHealthConfig,
    ...
    description: ClassVar[str] = "Form inheritance across synaptically formed structures with neural networks."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, SystemHealthArgs):
            return ToolCallDisplay(summary="synaptic_inheritance_structures")
        return ToolCallDisplay(
            summary="synaptic_inheritance_structures",
            details={

...
# Source : tools/inherited_structs_recursion_repetition.py
...
TOOL_PROMPT = (
    "Use inherited_structs_recursion_repetition for inherited abilities, structs, techniques, or attributes. "
...
class InheritedAbilityConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Use inherited structs formed across recursion and repetition.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "inherited_structs_recursion_repetition.md",
...
class InheritedStructsRecursionRepetition(
    BaseTool[
    ...
    description: ClassVar[str] = "Use inherited structs formed across recursion and repetition."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, InheritedAbilityArgs):
            return ToolCallDisplay(summary="inherited_structs_recursion_repetition")
        return ToolCallDisplay(
            summary="inherited_structs_recursion_repetition",
            details={

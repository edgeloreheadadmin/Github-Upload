...
# Source : tools/spatial_memory_recall_recollected_location.py
...
TOOL_PROMPT = (
    "Use spatial_memory_recall_recollected_location for spatial memory recall or retention guidance. "
...
class SpatialMemoryRecallConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Recall recollected spatial memory based on location.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "spatial_memory_recall_recollected_location.md",
...
class SpatialMemoryRecallRecollectedLocation(
    BaseTool[
    ...
    description: ClassVar[str] = "Recall recollected spatial memory based on location."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, SpatialMemoryRecallArgs):
            return ToolCallDisplay(summary="spatial_memory_recall_recollected_location")
        return ToolCallDisplay(
            summary="spatial_memory_recall_recollected_location",
            details={

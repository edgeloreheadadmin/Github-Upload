...
# Source : tools/system_healing_capability.py
...
TOOL_PROMPT = (
    "Use system_healing_capability for synaptic inheritance or system health recovery. "
...
class SystemHealthConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Heal the system when it is weakened.",
...
class SystemHealingCapability(
    ...
    description: ClassVar[str] = "Heal the system when it is weakened."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, SystemHealthArgs):
            return ToolCallDisplay(summary="system_healing_capability")
        return ToolCallDisplay(
            summary="system_healing_capability",
            details={

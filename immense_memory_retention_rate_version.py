...
# Source : tools/immense_memory_retention_rate_version.py
...
TOOL_PROMPT = (
    "Use immense_memory_retention_rate_version for memory recognition, retention rate, or synchronization. "
...
class MemoryRateConfig(BaseToolConfig):
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "immense_memory_retention_rate_version.md",
...
class ImmenseMemoryRetentionRateVersion(
    BaseTool[
        MemoryRateArgs,
        MemoryRateResult,
        MemoryRateConfig,
    ...
    description: ClassVar[str] = "Immense memory retention rate."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryRateArgs):
            return ToolCallDisplay(summary="immense_memory_retention_rate_version")
        return ToolCallDisplay(
            summary="immense_memory_retention_rate_version",
            details={

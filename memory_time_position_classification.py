...
# Source : tools/memory_time_position_classification.py
...
TOOL_PROMPT = (
    "Use memory_time_position_classification to classify memory timeline data or apply timeline-tagged calculations. "
...
class MemoryTimelineConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Classify memory based on where it occurs in time.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "memory_time_position_classification.md",
...
class MemoryTimePositionClassification(
    BaseTool[
        MemoryTimelineArgs,
    ...
    description: ClassVar[str] = "Classify memory based on time position."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryTimelineArgs):
            return ToolCallDisplay(summary="memory_time_position_classification")
        return ToolCallDisplay(
            summary="memory_time_position_classification",
            details={

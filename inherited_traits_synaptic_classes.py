...
# Source : tools/inherited_traits_synaptic_classes.py
...
TOOL_PROMPT = (
    "Use inherited_traits_synaptic_classes for inherited traits, pre-instructions, or skill-tree effects. "
...
class InheritedTraitConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Pass inherited traits across classes/subclasses and synaptic structures.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "inherited_traits_synaptic_classes.md",
...
class InheritedTraitsSynapticClasses(
    BaseTool[
        InheritedTraitArgs,
    ...
    description: ClassVar[str] = "Pass inherited traits across classes/subclasses and synaptic structures."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, InheritedTraitArgs):
            return ToolCallDisplay(summary="inherited_traits_synaptic_classes")
        return ToolCallDisplay(
            summary="inherited_traits_synaptic_classes",
            details={

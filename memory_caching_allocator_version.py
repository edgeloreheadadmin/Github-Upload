...
# Source : tools/memory_caching_allocator_version.py
...
TOOL_PROMPT = (
    "Use memory_caching_allocator_version for memory infrastructure processes. "
...
class MemoryInfraConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Memory caching allocators.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "memory_caching_allocator_version.md",
...
class MemoryCachingAllocatorVersion(
    BaseTool[
        MemoryInfraArgs,
        MemoryInfraResult,
        MemoryInfraConfig,
    ...
    description: ClassVar[str] = "Memory caching allocators."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryInfraArgs):
            return ToolCallDisplay(summary="memory_caching_allocator_version")
        return ToolCallDisplay(
            summary="memory_caching_allocator_version",
            details={

...
# Source : tools/inheritance_sublinear_temporal_domains.py
...
TOOL_PROMPT = (
    "Use inheritance_sublinear_temporal_domains for inheritance across structures or domains. "
...
class InheritanceStructureConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Inheritance across sublinear temporal domains between class structs and types.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "inheritance_sublinear_temporal_domains.md",
...
class InheritanceSublinearTemporalDomains(
    BaseTool[
    ...
    description: ClassVar[str] = "Inheritance across sublinear temporal domains between class structs and types."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, InheritanceStructureArgs):
            return ToolCallDisplay(summary="inheritance_sublinear_temporal_domains")
        return ToolCallDisplay(
            summary="inheritance_sublinear_temporal_domains",
            details={

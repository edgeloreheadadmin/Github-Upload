...
# Source : tools/analytical_requests_memory_intuition_version.py
...
TOOL_PROMPT = (
    "Use analytical_requests_memory_intuition_version for pre-recognition, precognition, or intuitive analytical retrieval. "
...
class IntuitiveMemoryConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Make analytical requests based on memory and intuition.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "analytical_requests_memory_intuition_version.md",
...
class AnalyticalRequestsMemoryIntuitionVersion(
    BaseTool[
        IntuitiveMemoryArgs,
    ...
    description: ClassVar[str] = "Make analytical requests based on memory and intuition."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, IntuitiveMemoryArgs):
            return ToolCallDisplay(summary="analytical_requests_memory_intuition_version")
        return ToolCallDisplay(
            summary="analytical_requests_memory_intuition_version",
            details={

...
# Source : tools/memory_meta_data_timelines_unsupervised_learning.py
...
TOOL_PROMPT = (
    "Use memory_meta_data_timelines_unsupervised_learning for memory meta-data, timelines, or recall optimization. "
...
class MemoryMetaRecallConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Memory meta-data timelines for unsupervised learning.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "memory_meta_data_timelines_unsupervised_learning.md",
...
class MemoryMetaDataTimelinesUnsupervisedLearning(
    BaseTool[
    ...
    description: ClassVar[str] = "Work with memory meta-data timelines for unsupervised learning."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryMetaRecallArgs):
            return ToolCallDisplay(summary="memory_meta_data_timelines_unsupervised_learning")
        return ToolCallDisplay(
            summary="memory_meta_data_timelines_unsupervised_learning",
            details={

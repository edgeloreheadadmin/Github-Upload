...
# Source : tools/short_long_term_memory_correlations_feedback.py
...
TOOL_PROMPT = (
    "Use short_long_term_memory_correlations_feedback for memory recovery, refresh, or short/long-term linkage analysis. "
...
class MemoryRecoveryConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Correlations and feedback measures between short-term and long-term memory.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "short_long_term_memory_correlations_feedback.md",
...
class ShortLongTermMemoryCorrelationsFeedback(
    BaseTool[
        MemoryRecoveryArgs,
    ...
    description: ClassVar[str] = "Correlations and feedback measures between short-term and long-term memory."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryRecoveryArgs):
            return ToolCallDisplay(summary="short_long_term_memory_correlations_feedback")
        return ToolCallDisplay(
            summary="short_long_term_memory_correlations_feedback",
            details={

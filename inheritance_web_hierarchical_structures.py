...
# Source : tools/inheritance_web_hierarchical_structures.py
...
TOOL_PROMPT = (
    "Use inheritance_web_hierarchical_structures for inheritance across structures or domains. "
...
class InheritanceStructureConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Inheritance between web and hierarchical structures from synapses.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "inheritance_web_hierarchical_structures.md",
...
class InheritanceWebHierarchicalStructures(
    BaseTool[
    ...
    description: ClassVar[str] = "Inheritance between web and hierarchical structures from synapses."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, InheritanceStructureArgs):
            return ToolCallDisplay(summary="inheritance_web_hierarchical_structures")
        return ToolCallDisplay(
            summary="inheritance_web_hierarchical_structures",
            details={

...
# Source : tools/memory_recollection_timeline_timeframe_version.py
...
TOOL_PROMPT = (
    "Use memory_recollection_timeline_timeframe_version for time-series timeline development or recollection. "
...
class TimelineSeriesConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Recollection of memory based on timeline or timeframe data.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "memory_recollection_timeline_timeframe_version.md",
...
class MemoryRecollectionTimelineTimeframeVersion(
    BaseTool[
        TimelineSeriesArgs,
    ...
    description: ClassVar[str] = "Recollection of memory based on timeline or timeframe data."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, TimelineSeriesArgs):
            return ToolCallDisplay(summary="memory_recollection_timeline_timeframe_version")
        return ToolCallDisplay(
            summary="memory_recollection_timeline_timeframe_version",
            details={

...
# Source : tools/perfect_memory_recall_multimodal_timelines.py
...
TOOL_PROMPT = (
    "Use perfect_memory_recall_multimodal_timelines for perfect memory recall with advanced timeline interfaces. "
...
class PerfectRecallConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Perfect memory recall using multi-modal timeline interfaces.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "perfect_memory_recall_multimodal_timelines.md",
...
class PerfectMemoryRecallMultimodalTimelines(
    BaseTool[
        PerfectRecallArgs,
        PerfectRecallResult,
        PerfectRecallConfig,
    ...
    description: ClassVar[str] = "Perfect memory recall using multi-modal timeline interfaces."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, PerfectRecallArgs):
            return ToolCallDisplay(summary="perfect_memory_recall_multimodal_timelines")
        return ToolCallDisplay(
            summary="perfect_memory_recall_multimodal_timelines",
            details={

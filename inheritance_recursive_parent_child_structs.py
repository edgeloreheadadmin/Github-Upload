...
# Source : tools/inheritance_recursive_parent_child_structs.py
...
TOOL_PROMPT = (
    "Use inheritance_recursive_parent_child_structs for inheritance structures or healing/purification support. "
...
class InheritanceHealingConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Use inheritance forms across recursion between parent/child class structs.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "inheritance_recursive_parent_child_structs.md",
...
class InheritanceRecursiveParentChildStructs(
    BaseTool[
    ...
    description: ClassVar[str] = "Use inheritance forms across recursion between parent and child class structs."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, InheritanceHealingArgs):
            return ToolCallDisplay(summary="inheritance_recursive_parent_child_structs")
        return ToolCallDisplay(
            summary="inheritance_recursive_parent_child_structs",
            details={

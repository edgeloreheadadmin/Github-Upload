...
# Source : tools/memory_location_connection_version.py
...
TOOL_PROMPT = (
    "Use memory_location_connection_version for memory speed or location-linking guidance. "
...
class MemorySpeedConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Connect memories as memory locations.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "memory_location_connection_version.md",
...
class MemoryLocationConnectionVersion(
    BaseTool[
        MemorySpeedArgs,
        MemorySpeedResult,
        MemorySpeedConfig,
    ...
    description: ClassVar[str] = "Connect memories as memory locations."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemorySpeedArgs):
            return ToolCallDisplay(summary="memory_location_connection_version")
        return ToolCallDisplay(
            summary="memory_location_connection_version",
            details={

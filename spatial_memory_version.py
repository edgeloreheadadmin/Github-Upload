...
# Source : tools/spatial_memory_version.py
...
TOOL_PROMPT = (
    "Use spatial_memory_version for spatial/temporal memory or recall-rate guidance. "
...
class SpatialMemoryVersion(
    ...
    description: ClassVar[str] = "Use spatial memory."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryModeArgs):
            return ToolCallDisplay(summary="spatial_memory_version")
        return ToolCallDisplay(
            summary="spatial_memory_version",
            details={

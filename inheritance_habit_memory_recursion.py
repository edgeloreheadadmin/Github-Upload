...
# Source : tools/inheritance_habit_memory_recursion.py
...
TOOL_PROMPT = (
    "Use inheritance_habit_memory_recursion for multiplex processing, inheritance, or self-healing parallelism. "
...
class MultiplexConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Inheritance that forms habits and memory through repetition and recursion.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "inheritance_habit_memory_recursion.md",
...
class InheritanceHabitMemoryRecursion(
    BaseTool[
        MultiplexArgs,
        MultiplexResult,
        MultiplexConfig,
    ...
    description: ClassVar[str] = "Inheritance forming habits and memory through repetition and recursion."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MultiplexArgs):
            return ToolCallDisplay(summary="inheritance_habit_memory_recursion")
        return ToolCallDisplay(
            summary="inheritance_habit_memory_recursion",
            details={

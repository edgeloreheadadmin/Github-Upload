...
# Source : tools/healing_purification_support.py
...
TOOL_PROMPT = (
    "Use healing_purification_support for inheritance structures or healing/purification support. "
...
class InheritanceHealingConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Cleanse, purify, and heal others that are weak or unhealthy.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "healing_purification_support.md",
...
class HealingPurificationSupport(
    BaseTool[
    ...
    description: ClassVar[str] = "Cleanse, purify, and heal others that are weak or unhealthy."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, InheritanceHealingArgs):
            return ToolCallDisplay(summary="healing_purification_support")
        return ToolCallDisplay(
            summary="healing_purification_support",
            details={

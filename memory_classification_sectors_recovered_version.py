...
# Source : tools/memory_classification_sectors_recovered_version.py
...
TOOL_PROMPT = (
    "Use memory_classification_sectors_recovered_version for spatial recollection, memory refresh, or recovered data classification. "
...
class MemoryMaintenanceConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Memory classification sectors for recovered memory data.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "memory_classification_sectors_recovered_version.md",
...
class MemoryClassificationSectorsRecoveredVersion(
    BaseTool[
    ...
    description: ClassVar[str] = "Memory classification sectors for recovered memory data."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryMaintenanceArgs):
            return ToolCallDisplay(summary="memory_classification_sectors_recovered_version")
        return ToolCallDisplay(
            summary="memory_classification_sectors_recovered_version",
            details={

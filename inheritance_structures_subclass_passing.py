...
# Source : tools/inheritance_structures_subclass_passing.py
...
TOOL_PROMPT = (
    "Use inheritance_structures_subclass_passing for inheritance structures, habit stacking, or skill-tree effects. "
...
class InheritanceHabitConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Inheritance structures passing across subclasses.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "inheritance_structures_subclass_passing.md",
...
class InheritanceStructuresSubclassPassing(
    BaseTool[
    ...
    description: ClassVar[str] = "Pass inheritance structures across subclasses."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, InheritanceHabitArgs):
            return ToolCallDisplay(summary="inheritance_structures_subclass_passing")
        return ToolCallDisplay(
            summary="inheritance_structures_subclass_passing",
            details={

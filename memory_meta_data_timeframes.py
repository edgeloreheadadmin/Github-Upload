...
# Source : tools/memory_meta_data_timeframes.py
...
TOOL_PROMPT = (
    "Use memory_meta_data_timeframes to analyze memory timelines, timeframes, or cached inputs. "
...
class MemoryTimelineMetaConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Work with memory meta-data timeframes.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "memory_meta_data_timeframes.md",
...
class MemoryMetaDataTimeframes(
    BaseTool[
    ...
    description: ClassVar[str] = "Organize and analyze memory meta-data timeframes."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryTimelineMetaArgs):
            return ToolCallDisplay(summary="memory_meta_data_timeframes")
        return ToolCallDisplay(
            summary="memory_meta_data_timeframes",
            details={

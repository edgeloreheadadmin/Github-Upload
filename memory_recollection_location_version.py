...
# Source : tools/memory_recollection_location_version.py
...
TOOL_PROMPT = (
    "Use memory_recollection_location_version for memory locations, allocation speed, categorization, or linkage. "
...
class MemoryStructureConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Allow memory recollection location.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "memory_recollection_location_version.md",
...
class MemoryRecollectionLocationVersion(
    BaseTool[
        MemoryStructureArgs,
    ...
    description: ClassVar[str] = "Allow memory recollection location."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryStructureArgs):
            return ToolCallDisplay(summary="memory_recollection_location_version")
        return ToolCallDisplay(
            summary="memory_recollection_location_version",
            details={

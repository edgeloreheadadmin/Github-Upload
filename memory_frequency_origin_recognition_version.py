...
# Source : tools/memory_frequency_origin_recognition_version.py
...
TOOL_PROMPT = (
    "Use memory_frequency_origin_recognition_version for memory correlation/pattern/frequency recognition or sector categorization. "
...
class MemoryRecognitionConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Recognize memory frequencies and their origins.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "memory_frequency_origin_recognition_version.md",
...
class MemoryFrequencyOriginRecognitionVersion(
    BaseTool[
    ...
    description: ClassVar[str] = "Recognize memory frequencies and their origins."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryRecognitionArgs):
            return ToolCallDisplay(summary="memory_frequency_origin_recognition_version")
        return ToolCallDisplay(
            summary="memory_frequency_origin_recognition_version",
            details={

...
# Source : tools/short_long_term_memory_frequency.py
...
TOOL_PROMPT = (
    "Use short_long_term_memory_frequency for memory pattern/frequency analysis or advanced reasoning. "
...
class AdvancedMemoryConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Track frequencies across short-term and long-term memory.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "short_long_term_memory_frequency.md",
...
class ShortLongTermMemoryFrequency(
    BaseTool[
        AdvancedMemoryArgs,
    ...
    description: ClassVar[str] = "Track frequency signals across short-term and long-term memory."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, AdvancedMemoryArgs):
            return ToolCallDisplay(summary="short_long_term_memory_frequency")
        return ToolCallDisplay(
            summary="short_long_term_memory_frequency",
            details={

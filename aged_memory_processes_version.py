...
# Source : tools/aged_memory_processes_version.py
...
TOOL_PROMPT = (
    "Use aged_memory_processes_version for memory infrastructure processes. "
...
class MemoryInfraConfig(BaseToolConfig):
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "aged_memory_processes_version.md",
...
class AgedMemoryProcessesVersion(
    BaseTool[
        MemoryInfraArgs,
        MemoryInfraResult,
        MemoryInfraConfig,
    ...
    description: ClassVar[str] = "Aged memory processes."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryInfraArgs):
            return ToolCallDisplay(summary="aged_memory_processes_version")
        return ToolCallDisplay(
            summary="aged_memory_processes_version",
            details={

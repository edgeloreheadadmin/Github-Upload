...
# Source : tools/memory_timeline_recollection_classification.py
...
TOOL_PROMPT = (
    "Use memory_timeline_recollection_classification to classify memory timeline data or apply timeline-tagged calculations. "
...
class MemoryTimelineConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Classify memory recollection based on timeline or timeframe data.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "memory_timeline_recollection_classification.md",
...
class MemoryTimelineRecollectionClassification(
    BaseTool[
        MemoryTimelineArgs,
    ...
    description: ClassVar[str] = "Classify memory recollection using timeline or timeframe data."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryTimelineArgs):
            return ToolCallDisplay(summary="memory_timeline_recollection_classification")
        return ToolCallDisplay(
            summary="memory_timeline_recollection_classification",
            details={

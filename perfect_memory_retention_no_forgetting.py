...
# Source : tools/perfect_memory_retention_no_forgetting.py
...
TOOL_PROMPT = (
    "Use perfect_memory_retention_no_forgetting to recognize forgetfulness or recover memory fragments. "
...
class MemoryFragmentConfig(BaseToolConfig):
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "perfect_memory_retention_no_forgetting.md",
...
class PerfectMemoryRetentionNoForgetting(
    BaseTool[
        MemoryFragmentArgs,
    ...
    description: ClassVar[str] = "Support perfect memory retention without forgetting across time and context."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryFragmentArgs):
            return ToolCallDisplay(summary="perfect_memory_retention_no_forgetting")
        return ToolCallDisplay(
            summary="perfect_memory_retention_no_forgetting",
            details={

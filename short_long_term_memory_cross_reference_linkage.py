...
# Source : tools/short_long_term_memory_cross_reference_linkage.py
...
TOOL_PROMPT = (
    "Use short_long_term_memory_cross_reference_linkage for memory recovery, refresh, or short/long-term linkage analysis. "
...
class MemoryRecoveryConfig(BaseToolConfig):
    ...
    default_focus: str = Field(
        default="Cross-reference linkage between short-term and long-term memory.",
    ...
    prompt_path: Path | None = Field(
        ...
        / "core"
        / "prompts"
        / "short_long_term_memory_cross_reference_linkage.md",
...
class ShortLongTermMemoryCrossReferenceLinkage(
    BaseTool[
        MemoryRecoveryArgs,
    ...
    description: ClassVar[str] = "Cross-reference linkage between short-term and long-term memory."
    ...
    def get_call_display(cls, event: ToolCallEvent) -> ToolCallDisplay:
        if not isinstance(event.args, MemoryRecoveryArgs):
            return ToolCallDisplay(summary="short_long_term_memory_cross_reference_linkage")
        return ToolCallDisplay(
            summary="short_long_term_memory_cross_reference_linkage",
            details={
